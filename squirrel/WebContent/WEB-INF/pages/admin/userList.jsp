...
<body>
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<h2>Squirrel用户信息</h2>
				<a class="btn btn-primary" href="/admin/exportUser">导出数据为excel</a> <a
					class="btn btn-primary" href="#" id="add">添加用户</a>
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li><a
							href="/admin/users?current=1&rowCount=10&sort[sender]=asc&searchPhrase=&id=b0df282a-0d67-40e5-8558-c9e93b7befed"
					...
					<div class="modal-body">
						<div class="form-group">
							<label for="userName1">userName</label> <input type="text"
								name="userName" class="form-control" id="userName1">
						</div>
						<div class="form-group">
							<label for="userAge1">userAge</label> <input type="text"
								name="userAge" class="form-control" id="userAge1">
						</div>
						<div class="form-group">
							<label for="userMajor1">userMajor</label> <input type="text"
								name="userMajor" class="form-control" id="userMajor1">
						</div>
						<div class="form-group">
