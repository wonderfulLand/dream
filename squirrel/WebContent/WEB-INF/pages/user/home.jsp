...
<body>
	<div class="pre-2" id="big_img">
		<img src="<%=basePath%>img/head_loading.gif"
		...
		<div id="user_area">
			<div id="home_header">
				<a href="<%=basePath%>goods/homeGoods">
					...
					src="<%=basePath%>img/home_header.jpg" style="margin-left: 20px;">
						...
						<form role="form" id="contextForm">
							<div class="pub_content">
								<div class="text_pub lead emoji-picker-container">
									<input type="text" name="context" data-emojiable="converted"
										class="form-control" data-type="original-input"
										style="display: none;" />
									<div class="emoji-wysiwyg-editor form-control"
										data-type="input" id="mycontext" contenteditable="true"></div>
