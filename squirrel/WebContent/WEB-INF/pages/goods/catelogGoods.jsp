...
<script>
      $(function(){
    	  $("#commonLeft").load('<%=basePath%>pages/commonLeft.jsp'); 
    	  $("#commonTop").load('<%=basePath%>pages/commonTop.jsp'); 	
    	  $("#commonlogIn").load('<%=basePath%>pages/commonlogIn.jsp'); 	
    	  $("#commonReg").load('<%=basePath%>pages/commonReg.jsp'); 	
    	  $("#commonModify").load('<%=basePath%>pages/commonModify.jsp'); 	
      });
</script>
</head>
